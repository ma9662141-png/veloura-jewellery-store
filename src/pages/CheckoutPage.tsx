...
Thank you! 🙏`;
  ...
  const handlePlaceOrder = async () => {
    ...
    const orderNumber = 'VJ-' + crypto.randomUUID().replace(/-/g, '').slice(0, 8).toUpperCase();
                  ...
                  <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-4">
                    ...
                    <ol className="space-y-1.5 text-xs text-muted-foreground list-none">
                      {[
                        ...
                        null, // rendered separately for the amount
                        ...
                        <li key={i} className="flex items-start gap-2">
                          ...
                          {i === 1 ? (
                            <span>Send <strong className="text-foreground">Rs. {total.toLocaleString()}</strong> to the number below</span>
                          ) : (
                            <span>{step}</span>
                          )}
                        </li>
